...
export default class OrderList extends React.Component {
  ...
  componentDidMount = async() => {
    ...
    const url = 'http://'+LocalIP+':3500/PR/success/'+userId
    await axios.get(url,{
  ...
  onConfirm = (id) => {
    this.props.navigation.push("Confirm",{ id: id })
  };
        ...
        <View style={styles.container}>
...

          {
            ...
            <View style={{width: 88 + '%',flex: 1, flexDirection: 'row',borderBottomColor: '#bdb9ae',borderBottomWidth: 2,marginBottom:5}}>
              ...
              <View style={{width: 20 + '%'}}>
                <TouchableOpacity style={[styles.listButton, styles.viewButton]} onPress={() => this.onConfirm(record._id)}>
